...
| FR-070E | P0 | The HTML ZIP includes local CSS, Photos-backed images and galleries, playable video files with poster frames, interactive Google Maps embeds and coordinates, captions, links, and accessible text fallbacks. It does not require RoamStory after extraction; maps and author-added external links require a network connection. |
